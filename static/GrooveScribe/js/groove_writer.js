...
function GrooveWriter() {
	...
	root.show_FullURLPopup = function () {
		...
		var ShareBut = new ShareButton({
				...
				networks: {
					facebook: {
						before: function () {
							this.url = get_FullURLForPage("display");
					...
					twitter: {
						before: function () {
							this.url = encodeURIComponent(get_FullURLForPage("display"));
							this.description = "Check out this groove:  " + get_FullURLForPage("display");
						}
					},
					reddit: {
						before: function () {
							this.url = get_FullURLForPage("display");
							this.title = "Check out this groove: " + get_FullURLForPage("display");
						}
					},
					email: {
						before : function () {
							this.url = get_FullURLForPage("display");
							this.description = "Check out this groove. %0A%0A " + encodeURIComponent(get_FullURLForPage("display"));
						}
					},
					pinterest: {
						enabled: false
	...
	function fillInEmbedURLInFullURLPopup(fullURL, cssIdOfTextFieldToFill) {
		var embedText = '<iframe width="100%" height="240" src="' + fullURL + '" frameborder="0" style="background-color: white;"></iframe>';
